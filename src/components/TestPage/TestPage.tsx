        ...
        return (
            ...
            <div className={sclasses.Main} style={ blockId === 0 ? {} : { paddingTop: 0 } }>
                {blockId === 0 && <>
                    ...
                    >
                        <p style={{marginTop: '16px'}}>У кожній із семи частин цього тесту розподіліть 10 балів між 8 твердженнями. Якщо ви згодні з будь-яким твердженням на всі 100%, ви можете віддати йому всі 10 балів.</p>                        <br/>
                        <p>Рекомендуємо розподіляти бали 5/3/2 для достовірності результату.</p>
                        <br/>
                        <p>За результатами проходження тесту буде визначено вашу роль у команді.</p>
                    </Typography>
                </>}
                ...
                <div className={
                    ...
                    >
                        <p>У кожній із семи частин цього тесту розподіліть 10 балів між 8-ма твердженнями. Якщо ви згодні з будь-яким твердженням на всі 100%, ви можете віддати йому всі 10 балів. </p>
